...
If other studies would like to use the large amount of telomere length data supplied in our paper, We believe that a sound way to compare results would be to include the representative strains of the teloblot in the new sequencing batch. The TL estimations of these shared strains should be compared between the sequencing batches and the teloblot values, in order to re-calculate correction factors for both batches. 
